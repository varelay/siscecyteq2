...
<table id="tablax" class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        ...
        $query="select distinct alumno from tbpedorra";
        $query2="select * from tbpedorra";
       ...
       <tr>
         ...
         <div class="col mb-2">
            <a class="oculto" style="color: blue;" href="#"><img src=imagenes/editar.png>  Editar</a><br>
         </div>
        <div>
            <a class="oculto "style="color: green;" href="dsad#"><img src=imagenes/cheque.png>  Entregado</a></td>
        </div> 
