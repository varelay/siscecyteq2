...
<div class="container" style="padding: 5px; background: white; width: 1500px; height: auto; margin: 0vw 2vw; border-radius: 10px; box-shadow: 0px 0px 10px 0px #323435; display:block;
        ...
        <table id="tablax" class="table table-striped table-bordered" style="text-align: center;">
            <thead>
                ...
                <th style="text-align:center;vertical-align: middle;">No. Inventario</th>
            ...
            <tbody>
              <?php
                ...
                $query="select quimico,inv, DATE_FORMAT(caducidad,'%d-%m-%Y') as caducidad, info,Imagen from tbquimicos";
               ...
               <tr>
                 ...
                 <td style="width:100px;text-align:center;vertical-align: middle;"><?php echo $row['caducidad'] ?></td>
                 ...
                 <td style="width:150px;text-align:center;vertical-align: middle;"><a href="#"><img src=imagenes/borrar.png>  Eliminar</a><br><br><a href="dsad#"><img src=imagenes/actualizar.png>  Actualizar</a></td>
