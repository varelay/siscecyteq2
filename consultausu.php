...
<table id="tablax" class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        ...
        $query="select usuario,pass from tbusuarios";
        $resultado=$conexion->query($query);
        while($row=$resultado->fetch_assoc()){
       ?>
       <tr>
         <td style="text-align:center;vertical-align: middle;"><?php echo $row['usuario'] ?></td>
         <td style="width:150px;text-align:center;vertical-align: middle;"><a class="oculto" style="color: red;" href="#"><img src=imagenes/borrar.png>  Eliminar</a><br><br><a class="oculto "style="color: black;" href="dsad#"><img src=imagenes/actualizar.png>  Actualizar</a></td>
